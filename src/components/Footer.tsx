        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              <a href="https://www.instagram.com/cvjecarascekic" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 border border-brand-pink/40 text-brand-light rounded-full px-7 py-3 hover:bg-brand-pink hover:text-brand-light transition-all duration-300 font-semibold text-xs uppercase tracking-widest">
                <Instagram className="h-4 w-4 text-brand-pink group-hover:text-brand-light transition-colors" />
                Instagram
              </a>
              <a href="https://www.facebook.com/CvjecaraScekic" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 border border-brand-pink/40 text-brand-light rounded-full px-7 py-3 hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-brand-light transition-all duration-300 font-semibold text-xs uppercase tracking-widest">
              ...
              <li className="flex flex-col gap-3 pt-2">
                ...
                <div className="pl-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <a href="viber://chat?number=%2B38269108055" className="inline-flex items-center gap-1.5 bg-[#7360F2] text-white text-[10px] uppercase tracking-wider font-semibold px-3 py-2 rounded-full hover:bg-opacity-80 transition-all shadow-sm">Viber</a>
                    <a href="https://wa.me/38269108055" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 bg-[#25D366] text-white text-[10px] uppercase tracking-wider font-semibold px-3 py-2 rounded-full hover:bg-opacity-80 transition-all shadow-sm">WhatsApp</a>
                  </div>
                </div>
              </li>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16 mt-8">
          <div className="bg-brand-light/5 p-2 rounded-3xl border border-brand-light/10">
            ...
            <div className="w-full h-64 rounded-2xl overflow-hidden relative">
              <iframe src="https://maps.google.com/maps?q=43.0559417,19.770745&t=&z=15&ie=UTF8&iwloc=&output=embed" className="absolute top-0 left-0 w-full h-full border-0 grayscale-[20%] contrast-125" allowFullScreen loading="lazy"></iframe>
            </div>
          </div>
          <div className="bg-brand-light/5 p-2 rounded-3xl border border-brand-light/10">
            <h4 className="text-center font-serif text-brand-pink mb-3 text-sm tracking-wide">Cvjećara 2 - Tržni centar Bravera</h4>
            <div className="w-full h-64 rounded-2xl overflow-hidden relative">
              <iframe src="https://maps.google.com/maps?q=Trzni%20centar%20Bravera,%20Bijelo%20Polje&t=&z=15&ie=UTF8&iwloc=&output=embed" className="absolute top-0 left-0 w-full h-full border-0 grayscale-[20%] contrast-125" allowFullScreen loading="lazy"></iframe>
            </div>
          </div>
        </div>
