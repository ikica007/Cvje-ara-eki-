            ...
            <ul className="space-y-4 font-serif font-light text-brand-light/90">
              <li className="flex items-start gap-3">
                ...
                <div className="text-sm space-y-2">
                  ...
                  <p><strong className="text-brand-pink font-semibold">PG Cvjećara 3:</strong><br/>Stari Aerodrom (Uskoro)</p>
                </div>
              </li>
...
const mapsHtml = `</div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16 mt-8">
          <div className="bg-brand-light/5 p-2 rounded-3xl border border-brand-light/10">
            <h4 className="text-center font-serif text-brand-pink mb-3 text-sm tracking-wide">Cvjećara 1 - ul. Petra Cetinjskog 52</h4>
