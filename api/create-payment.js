...
export default async function handler(req, res) {
  ...
  try {
    ...
    const hppBody = {
      ...
      successUrl: `${env.siteUrl}/?payment=success&ref=${reference}`,
      errorUrl: `${env.siteUrl}/?payment=error&ref=${reference}`,
      cancelUrl: `${env.siteUrl}/?payment=cancel&ref=${reference}`,
